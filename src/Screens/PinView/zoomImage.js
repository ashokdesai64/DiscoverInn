...
import { Dimensions, Modal, Platform, View, TouchableOpacity } from "react-native";
...
const ZoomImage = ({ closeModal, uri, navigation, isSaved, isOffline, removeFromTrip, openSaveToListModal }) => {
  let paddingTop = 0,
    headerHeight = 60;
  if (Platform.OS === 'ios') {
